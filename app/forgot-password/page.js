        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 sm:p-8">
          {submitted ? (
            <div className="text-center py-4">
              ...
              <Link href="/login" className="text-sm text-amber-600 hover:text-amber-600 transition-colors font-semibold">
                Back to login
              </Link>
            </div>
          ) : (
            <>
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-6">
                  ...
                  <input
                    ...
                    required
                    className="w-full px-3.5 py-2.5 bg-gray-50 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-200 transition-all text-gray-900 placeholder:text-gray-400 text-sm"
                  />
                </div>
              ...
              <div className="mt-5 pt-5 border-t border-gray-100 text-center">
                <p className="text-sm text-gray-500">
                  ...
                  <Link href="/login" className="text-amber-600 font-semibold hover:text-amber-600 transition-colors">
                    Log in
                  </Link>
                </p>
              </div>
