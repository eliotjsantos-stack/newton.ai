...
function GlassPane() {
  ...
  return (
    ...
    >
      <div
        className="relative rounded-2xl overflow-hidden bg-[var(--bg-elevated)] border border-white/8 shadow-xl"
      >
        {/* Title bar */}
        <div className="flex items-center justify-between px-4 py-3 border-b border-white/5 bg-[var(--bg-surface)]">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] text-white ml-2 tracking-wide">Biology — AQA 4.1 Cell Biology</span>
          </div>
        </div>
        ...
        <div className="relative z-10 px-4 pb-3">
          <div className="flex items-center gap-3 px-4 py-3 rounded-2xl border border-white/8 bg-[var(--bg-surface)]">
            <span className="text-[13px] text-white">Ask about Mitosis...</span>
...
function ExamBoardScroll() {
  ...
  useEffect(() => {
    const update = () => {
      ...
      setFanSpread(w < 400 ? 60 : w < 640 ? 90 : 260);
    };
    update();
  ...
  return (
    <section className="py-24 px-6 border-t border-white/8 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative h-[220px] sm:h-[280px] max-w-[260px] sm:max-w-lg mx-auto perspective-[1200px]">
          {boards.map((board, i) => {
            ...
            return (
              ...
              >
                <div className="w-full h-[200px] sm:h-[240px] rounded-2xl p-6 sm:p-8 flex flex-col justify-between bg-[var(--bg-elevated)] border border-white/8 shadow-md">
                  <div>
                    <div className="text-2xl font-bold text-white tracking-tight">{board.name}</div>
                    <div className="text-sm text-white mt-1">{board.subtitle}</div>
                  </div>
        ...
        >
          <div className="rounded-xl p-6 flex items-start gap-4 bg-[var(--bg-elevated)] border border-white/8 card-shadow">
  ...
  return (
    <div className={`flex flex-col ${reverse ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-8 md:gap-16 lg:gap-24`}>
      <div className="flex-1 max-w-xl min-w-0">
        ...
        <h3 className="font-display text-2xl sm:text-4xl md:text-5xl font-bold text-white tracking-tighter mb-6">{title}</h3>
        <p className="hidden sm:block text-lg text-white leading-relaxed">{description}</p>
      </div>
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-base)]">
      {/* ─── Entrance ─── */}
      <motion.div
        className="fixed inset-0 bg-[var(--bg-base)] z-[100] pointer-events-none"
        initial={{ opacity: 1 }}
        animate={{ opacity: 0 }}
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-1">
              {['Features', 'How It Works', 'Subjects', 'Privacy', 'FAQ'].map((label) => (
                <a
                  ...
                  className="px-4 py-2 text-sm text-white hover:text-white font-medium rounded-full transition-colors duration-200"
                >
                  {label}
                </a>
              ))}
            ...
            <div className="hidden md:flex items-center gap-3">
              <Link
                href="/login"
                className="px-4 py-2 text-sm text-white hover:text-white font-medium transition-colors duration-200"
              >
                Log In
              </Link>
              <Link
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              className="md:hidden overflow-hidden border-t border-white/8 bg-[var(--bg-elevated)]"
            >
              <div className="px-6 py-6 space-y-1">
                {['Features', 'How It Works', 'Subjects', 'Privacy', 'FAQ'].map((label) => (
                  <a
                    ...
                    className="block px-4 py-3 text-white hover:text-white font-medium rounded-lg hover:bg-[var(--bg-surface)] transition-all"
                  >
                    {label}
                  </a>
                ))}
                <div className="pt-4 space-y-2">
                  <Link href="/login" className="block px-4 py-3 text-white hover:text-white font-medium rounded-lg hover:bg-[var(--bg-surface)] transition-all">
                    Log In
                  </Link>
      ...
      <section ref={heroRef} className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-6">
          <motion.h1
            className="text-6xl sm:text-7xl md:text-8xl lg:text-[7rem] font-bold text-white tracking-tight leading-[0.92]"
          ...
          >
            Curriculum-grounded AI for UK secondary schools. Guides students to understand — never does the work for them.
          </motion.p>
          <motion.div
          ...
          >
            <Link href="/signup" className="px-8 py-3.5 bg-[#0071E3] text-white text-sm font-semibold rounded-full hover:bg-[#0058B3] transition-colors duration-200">
              Try Newton
            </Link>
            <Link href="/about" className="px-8 py-3.5 border border-white/20 text-white text-sm font-semibold rounded-full hover:border-white/40 hover:bg-white/5 transition-colors duration-200">
              For schools →
            </Link>
          </motion.div>
        </div>
      ...
      {/* ─── Trust Strip ─── */}
      <section className="py-24 px-6 border-t border-b border-white/8">
      ...
      <section id="features" className="py-24 px-6 lg:px-12">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-6 max-w-[400px] mx-auto lg:max-w-none">
            ...
            <ScrollReveal>
              <div
                className="h-full rounded-xl p-6 md:p-10 bg-[var(--bg-elevated)] border border-white/8 hover:border-white/15 card-shadow transition-colors duration-200"
              >
            ...
            <ScrollReveal delay={0.1}>
              ...
              >
                <div className="w-12 h-12 rounded-2xl bg-blue-500/10 flex items-center justify-center mb-5 md:mb-8">
      ...
      <section className="py-24 px-6 lg:px-12 border-t border-white/8 overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <ScrollReveal className="text-center mb-10 md:mb-20">
            <p className="text-sm font-semibold tracking-widest uppercase text-[var(--c-accent)] mb-4">
            ...
            <p className="hidden sm:block text-xl text-white max-w-2xl mx-auto font-medium leading-relaxed">
          ...
          <ScrollCarousel count={3} className="flex sm:grid sm:grid-cols-3 gap-4 mb-16 overflow-x-auto hide-scrollbar snap-x snap-mandatory sm:overflow-visible -mx-6 px-6 sm:mx-0 sm:px-0">
            {[
              ...
              },
              {
                ...
                detail: 'International and domestic qualifications. Every qualification loaded and indexed for grounding.',
              },
              {
                board: 'OCR',
                full: 'Oxford, Cambridge and RSA',
                detail: 'OCR qualifications loaded and indexed. Grounding available across GCSE and A-Level qualification types.',
              },
            ].map((b) => (
              <ScrollReveal key={b.board} className="min-w-[260px] sm:min-w-0 snap-start shrink-0 sm:shrink">
                <div
                  className="rounded-xl p-6 sm:p-8 h-full flex flex-col bg-[var(--bg-elevated)] border border-white/8 hover:border-white/15 card-shadow transition-colors duration-200"
                >
                  <h3 className="text-2xl font-bold text-white tracking-tight mb-1">{b.board}</h3>
                  <p className="text-sm text-white mb-3">{b.full}</p>
                  <p className="text-sm text-white leading-relaxed flex-1 line-clamp-2 sm:line-clamp-none">{b.detail}</p>
          ...
          <ScrollReveal className="text-center">
            <div
              className="inline-flex items-center gap-3 rounded-xl px-6 py-4 bg-[var(--bg-elevated)] border border-white/8 card-shadow"
            >
              <span className="text-4xl font-bold text-white tracking-tighter">1,318</span>
              <span className="text-sm text-white text-left leading-tight">
      ...
      <section id="institutions" className="py-24 px-6 lg:px-12 border-t border-white/8">
        <div className="max-w-6xl mx-auto">
          ...
          <ScrollReveal className="mb-8 md:mb-12">
            <div className="relative">
              ...
              <div className="absolute -bottom-3 inset-x-0 flex justify-center">
                <span className="px-3 py-1 text-[10px] font-medium text-white/90 bg-white/15 backdrop-blur-sm rounded-full border border-white/8 shadow-sm">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mt-8">
            {/* Integrity & Honesty */}
            <ScrollReveal>
              <div className="h-full rounded-xl p-6 md:p-8 bg-[var(--bg-elevated)] border border-white/8 hover:border-white/15 card-shadow transition-colors duration-200">
                ...
                <p className="text-sm text-white mb-6 leading-relaxed">Every session is logged. Every result is earned.</p>
                ...
                <div className="mt-5 pt-5 border-t border-white/5">
                  <div className="flex items-center gap-2">
                    <div className="flex -space-x-1">
                      ...
                      <div className="w-5 h-5 rounded-full bg-[#0071E3]/20 border border-blue-400/30" />
                      <div className="w-5 h-5 rounded-full bg-red-500/20 border border-red-500/30" />
                    </div>
                    <p className="text-xs text-white">Red → Amber → Green mastery lifecycle</p>
                  </div>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.16}>
              <div className="h-full rounded-xl p-6 md:p-8 bg-[var(--bg-elevated)] border border-white/8 hover:border-white/15 card-shadow transition-colors duration-200 md:col-span-2 lg:col-span-1">
                ...
                <div className="space-y-4">
                  <div className="rounded-xl bg-[var(--bg-surface)] border border-white/8 p-4">
                    <p className="text-sm font-semibold text-white">Automatic Gap Analysis</p>
                    <p className="text-xs text-white mt-1">See which topics each student is struggling with — without reading every chat</p>
                  </div>
                  <div className="rounded-xl bg-[var(--bg-surface)] border border-white/8 p-4">
                    <p className="text-sm font-semibold text-white">Class Mastery Dashboards</p>
                    <p className="text-xs text-white mt-1">Per-student and class-wide topic mastery views, updated after every session</p>
                  </div>
                </div>
              </div>
            </ScrollReveal>
      ...
      <section className="py-24 px-6 lg:px-12 border-t border-white/8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            {/* Left: Standard LLM */}
            <ScrollReveal>
              <div className="h-full rounded-xl p-6 md:p-8 bg-[var(--bg-elevated)] border border-red-500/20 hover:border-red-500/30 card-shadow transition-colors duration-200 relative overflow-hidden">
                {/* Subtle red glow */}
                ...
                {/* Fake chat bubble */}
                <div className="relative rounded-xl bg-[var(--bg-surface)] border border-white/8 p-5 mb-5">
            ...
            {/* Right: Newton */}
            <ScrollReveal delay={0.08}>
              <div className="h-full rounded-xl p-6 md:p-8 bg-[var(--bg-elevated)] border border-emerald-500/20 hover:border-emerald-500/30 card-shadow transition-colors duration-200 relative overflow-hidden">
                {/* Subtle emerald glow */}
                ...
                {/* Newton chat bubble */}
                <div className="rounded-xl bg-[var(--bg-surface)] border border-white/8 p-5 mb-4">
                  <p className="text-[13px] text-white leading-relaxed mb-3">Great question! Let&apos;s work through this step by step.</p>
                  <div className="space-y-2.5">
                    {[
                      ...
                      <div key={i} className="flex items-start gap-2.5">
                        ...
                        <p className="text-[13px] text-white leading-relaxed">{q}</p>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                {/* Input field */}
                <div className="flex items-center px-4 py-3 rounded-xl bg-[var(--bg-surface)] border border-white/8 mb-5">
                  <span className="text-[13px] text-white">Your answer here...</span>
          ...
          <ScrollReveal delay={0.16}>
            <div className="mt-8 md:mt-12 grid grid-cols-3 gap-4">
              {[
                ...
                <div key={stat.label} className="rounded-xl bg-[var(--bg-elevated)] border border-white/8 hover:border-white/15 card-shadow transition-colors duration-200 p-5 md:p-6 text-center">
                  <div className="w-8 h-8 rounded-xl bg-blue-500/10 flex items-center justify-center mx-auto mb-3">
      ...
      <section className="py-24 px-6 lg:px-12 border-t border-white/8">
        <div className="max-w-6xl mx-auto">
          ...
          <ScrollReveal>
            <div className="grid md:grid-cols-3 gap-4 md:gap-6 mb-10 md:mb-16">
              {[
                ...
                <div key={item.title} className="rounded-xl p-6 md:p-8 bg-[var(--bg-elevated)] border border-white/8 hover:border-white/15 card-shadow transition-colors duration-200">
                  <div className="w-10 h-10 rounded-xl bg-blue-500/10 flex items-center justify-center mb-6">
                    <svg className="w-5 h-5 text-[#0071E3]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
          ...
          <ScrollReveal className="max-w-3xl mx-auto mb-10 md:mb-16">
            <div className="rounded-xl border border-white/8 bg-[var(--bg-surface)] p-6 md:p-8">
              <GradeCurveDemo />
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.1}>
            <div className="rounded-xl p-6 md:p-10 bg-[var(--bg-elevated)] border border-blue-500/20 hover:border-blue-500/30 card-shadow transition-colors duration-200">
      ...
      <section id="privacy" className="py-24 px-6 lg:px-12 border-t border-white/8">
        <div className="max-w-6xl mx-auto">
          <ScrollReveal className="text-center mb-10 md:mb-20">
      ...
      {/* ─── FAQ ─── */}
      <section id="faq" className="py-24 px-6 lg:px-12 border-t border-white/8">
        <div className="max-w-3xl mx-auto">
          <ScrollReveal className="text-center mb-8 md:mb-16">
            <h2 className="font-display text-2xl sm:text-5xl md:text-7xl font-bold text-white tracking-tighter mb-6">FAQ</h2>
          </ScrollReveal>
          ...
          <div className="space-y-2">
            {[
              ...
              <ScrollReveal key={i} delay={i * 0.03}>
                <div
                  className="rounded-xl overflow-hidden border border-white/8 hover:border-white/15 transition-colors duration-200"
                >
                  <button
                    onClick={() => setActiveAccordion(activeAccordion === i ? null : i)}
                    className="w-full px-6 py-5 text-left flex items-center justify-between hover:bg-[var(--bg-surface)] transition-colors duration-200"
                  >
                  ...
                  <AnimatePresence>
                    {activeAccordion === i && (
                      ...
                      >
                        <div className="px-6 pb-5 text-white text-sm leading-relaxed">
                          {faq.a}
                        </div>
                      </motion.div>
                    )}
      ...
      <section className="relative py-24 px-6 lg:px-12 bg-[#1a1a1a] overflow-hidden">
        ...
        <ScrollReveal className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <p className="hidden sm:block text-xl text-white mb-8 md:mb-12 max-w-xl mx-auto font-medium leading-relaxed">
      ...
      <footer className="py-10 px-6 sm:px-8 lg:px-12 border-t border-white/8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-8 pt-6 border-t border-white/8 text-center">
            <p className="text-sm text-white">&copy; 2026 Newton. Built with academic integrity at its core.</p>
          </div>
        </div>
      </footer>
    </div>
