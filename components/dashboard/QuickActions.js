  ...
  return (
    <div className="p-4 lg:p-5">
      <div className="flex gap-2.5 overflow-x-auto hide-scrollbar snap-x snap-mandatory sm:grid sm:grid-cols-4 sm:overflow-visible -mx-1 px-1">
        {actions.map((a) => {
          const inner = (
            <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-white hover:bg-gray-50 border border-gray-200 transition-colors group min-w-[140px] snap-start shrink-0 sm:shrink sm:min-w-0">
