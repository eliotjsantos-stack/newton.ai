      ...
      <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 p-5 w-80">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            disabled={generating}
            className="flex-1 py-2 text-sm font-medium bg-amber-600 hover:bg-amber-700 disabled:bg-neutral-300 text-white rounded-xl transition-colors flex items-center justify-center gap-2"
          >
            {generating ? (
              <>
